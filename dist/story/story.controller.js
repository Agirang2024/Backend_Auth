...
let StoryController = class StoryController {
    ...
    async getStoriesPreviewById(userId) {
        return await this.storyService.getStoriesPreviewById(userId);
    }
    async getStoriesDetailById(storyId) {
        return await this.storyService.getStoriesDetailById(storyId);
    }
};
exports.StoryController = StoryController;
__decorate([
    (0, common_1.Get)("preview/:userId"),
    __param(0, (0, common_1.Param)("userId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StoryController.prototype, "getStoriesPreviewById", null);
__decorate([
    (0, common_1.Get)("detail/:storyId"),
    __param(0, (0, common_1.Param)("storyId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StoryController.prototype, "getStoriesDetailById", null);
